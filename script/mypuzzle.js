...
function menuChg() {
    ...
    if (pageCount == 6 || pageCount == 7) {
        $('.side-pager li').eq(5).addClass('on').siblings().removeClass('on');
    }
    if (pageCount == 8) {
        $('.side-pager li').eq(6).addClass('on').siblings().removeClass('on');
    }
    if (pageCount == 9) {
        $('.side-pager li').eq(7).addClass('on').siblings().removeClass('on');
    }
    if (pageCount == 10){
        $('.side-pager li').eq().addClass('on').siblings().removeClass('on');
    }
}
